...
contract('Flight Surety Tests', async (accounts) => {
  ...
  it('(airline) cannot register an Airline using registerAirline() if it is not funded', async () => {
    ...
    try {
        ...
        await config.flightSuretyApp.fund({from: config.secondAirline,
                                   value: web3.utils.toWei('10', 'ether'),
                                   gas: 2000000,
                                   gasPrice: 1
                                  });
    ...
    let fifthAirlineNumberOfAirlines = await config.flightSuretyApp.getNumberOfAirlines({from: config.secondAirline,
                                                                                      gas: 2000000,
                                                                                      gasPrice: 1})
